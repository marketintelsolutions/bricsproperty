export const services = [
  {
    ...
    list: [
      ...
      "Master Planning & Design Management",
      "Sales & Marketing",
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      ...
      "Our expertise lies in sourcing funds and investors for the following purposes:",
    ],
    list: [
      "The implementation of real estate projects.",
      "Restructuring of existing loans.",
      "Contract buyouts or financing arrangements.",
    ],
  },
  {
    image: "building",
